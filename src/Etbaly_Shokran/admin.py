...
from Etbaly_Shokran.models import Etbaly_Shokran_Order,Etbaly_Shokran_Customer,Etbaly_Shokran_OrderDetail,Etbaly_Shokran_FeedBack,Etbaly_Shokran_Inquiry

class OrderInline(admin.TabularInline):
    model = Etbaly_Shokran_Order
    extra = 0
    # fields = ['OrderId','Source','Status','Feedback','Transfer',"Cash","Cost","Net","ITEMS","Shipping"]
    # exclude = ('Sales', )
    
@admin.register(Etbaly_Shokran_Customer)
...
class OrderDetailInline(admin.TabularInline):
    model = Etbaly_Shokran_OrderDetail
    extra = 0
    
@admin.register(Etbaly_Shokran_Order)
...
@admin.register(Etbaly_Shokran_OrderDetail)
...
class FeedBackInline(admin.TabularInline):
    model = Etbaly_Shokran_FeedBack
    extra = 0
    
@admin.register(Etbaly_Shokran_Inquiry)
...
@admin.register(Etbaly_Shokran_FeedBack)
